...
#define BUS_PANEL_PROXY_GET_CLASS(obj)   \
    (G_TYPE_CHECK_GET_CLASS ((obj), BUS_TYPE_PANEL_PROXY, BusPanelProxyClass))
...
void             bus_panel_proxy_set_cursor_location
                                                    (BusPanelProxy      *panel,
                                                     ...
                                                     gint32              w,
                                                     gint32              h);
void             bus_panel_proxy_update_preedit     (BusPanelProxy      *panel,
                                                     const gchar        *text,
                                                     IBusAttrList       *attr_list,
                                                     gint                cursor_pos,
                                                     gboolean            visible);
void             bus_panel_proxy_show_preedit       (BusPanelProxy      *panel);
void             bus_panel_proxy_hide_preedit       (BusPanelProxy      *panel);
void             bus_panel_proxy_update_aux_string  (BusPanelProxy      *panel,
                                                     const gchar        *text,
                                                     IBusAttrList       *attr_list,
                                                     gboolean            visible);
void             bus_panel_proxy_show_aux_string    (BusPanelProxy      *panel);
void             bus_panel_proxy_hide_aux_string    (BusPanelProxy      *panel);
